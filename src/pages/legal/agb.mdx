...
1. Support++ WhatsApp API, ist eine Schnittstelle zum Versenden von Benachrichtigungen im Zusammenhang mit dem Open-Source-Projekt Support++. Die Schnittstelle kann Nachrichten an eine verifizierte Nummer über den Messenger WhatsApp zustellen.
...
Möchte der Kunde dieses Produkt im Rahmen seiner oder einer gewerblichen Tätigkeit nutzen, verpflichtet er sich vor Registrierung dies bei uns anzuzeigen. Dieses erfolgt über eine kurze E-Mail an **support@klexhub.com** mit dem **Betreff: gewerbliche Tätigkeit. Support++ WhatsApp API.** 
